...
<html lang="en">
<head>
<title>Educational An Education Category Bootstrap Responsive Website Template | Home :: TheBestTutorials</title>
<!-- Meta tag Keywords -->
...
<link href="/assets/user/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
<link href="/assets/user/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
<!-- //css files -->
<!-- online-fonts -->
...
<div id="about" class="about">
	...
	<div class="about-info">
		<img src="/assets/user/images/ab.jpg" alt="about-image">
...
<div class="services" id="services">
		...
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="/assets/user/images/book.png" alt=" " /></a>
			</div>
			<h4>Service 1</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="/assets/user/images/edu.png" alt=" " /></a>
			</div>
			<h4>Service 2</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="/assets/user/images/uni.png" alt=" " /></a>
			</div>
			<h4>Service 3</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="/assets/user/images/hourglass.png" alt=" " /></a>
			</div>
			<h4>Service 4</h4>
			<p>Lorem Ipsum</p>
		</div>
		<div class="col-md-2 services-gd text-center" data-wow-delay=".5s">
			<div class="hi-icon-wrap hi-icon-effect-9 hi-icon-effect-9a">
				<a href="#" class="hi-icon"><img src="/assets/user/images/book2.png" alt=" " /></a>
			</div>
			<h4>Service 5</h4>
			<p>Lorem Ipsum</p>
		</div>
		...
		<div class="portfolio-top wow fadeInDown animated" data-wow-delay=".5s">
			...
			<div class="col-md-4 grid slideanim">
				...
				<a href="#portfolioModal1"  data-toggle="modal">
					...
					<img src="/assets/user/images/g1.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4>Educational</h4>
			...
			<div class="col-md-4 grid slideanim">
				...
				<a href="#portfolioModal2"  data-toggle="modal">
					...
					<img src="/assets/user/images/g2.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4>Educational</h4>
							<p> Education is not a problem. Education is an opportunity.</p>							
						</figcaption>	
			...
			<div class="col-md-4 grid slideanim">
				...
				<a href="#portfolioModal3"  data-toggle="modal">
					...
					<img src="/assets/user/images/g3.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4>Educational</h4>
							<p> Education is not a problem. Education is an opportunity.</p>							
						</figcaption>
		...
		<div class="portfolio-top wow fadeInUp animated" data-wow-delay=".5s">
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal4"  data-toggle="modal">
					...
					<img src="/assets/user/images/g4.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
			...
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal5"  data-toggle="modal">
					...
					<img src="/assets/user/images/g5.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4 class="effcet-text"> Educational</h4>
							<p>Learning is never done without errors and defeat.</p>							
						</figcaption>
			...
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal6"  data-toggle="modal">
					...
					<img src="/assets/user/images/g6.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4 class="effcet-text">Educational</h4>
							<p>Learning is never done without errors and defeat.</p>							
						</figcaption>
			...
			<div class="col-md-3 grid grid-wi slideanim">
				...
				<a href="#portfolioModal7"  data-toggle="modal">
					...
					<img src="/assets/user/images/g7.jpg" alt="img25" class="img-responsive"/>
						<figcaption>
							<h4 class="effcet-text"> Educational</h4>
							<p> Learning is never done without errors and defeat.</p>							
						</figcaption>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g1.jpg" class="img-responsive" alt="">
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g2.jpg" class="img-responsive" alt="">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g3.jpg" class="img-responsive" alt="">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g4.jpg" class="img-responsive" alt="">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g5.jpg" class="img-responsive" alt="">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g6.jpg" class="img-responsive" alt="">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <img src="/assets/user/images/g7.jpg" class="img-responsive" alt="">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
		...
		<div class="team_gds">
			<div class="col-md-3 team_gd1 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
				<div class="team_pos">
					...
					<img class="img-responsive" src="/assets/user/images/t1.jpg"  alt=" ">
					<div class="team_info">
			...
			<div class="col-md-3 team_gd1 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
				<div class="team_pos">
					<div class="team_back"></div>
					<img class="img-responsive" src="/assets/user/images/t2.jpg"  alt=" ">
					<div class="team_info">
						<a href="#"  class="face_one"><i class=" so1 fa fa-facebook fc1" aria-hidden="true"></i></a>
						<a href="#"  class="face_one"><i class=" so2 fa fa-twitter fc2" aria-hidden="true"></i></a>
						<a href="#"  class="face_one"><i class=" so3 fa fa-google fc3" aria-hidden="true"></i></a>
			...
			<div class="col-md-3 team_gd1 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
				<div class="team_pos">
					<div class="team_back"></div>
					<img class="img-responsive" src="/assets/user/images/t3.jpg"  alt=" ">
					<div class="team_info">
						<a href="#"  class="face_one"><i class=" so1 fa fa-facebook fc1" aria-hidden="true"></i></a>
						<a href="#"  class="face_one"><i class=" so2 fa fa-twitter fc2" aria-hidden="true"></i></a>
						<a href="#"  class="face_one"><i class=" so3 fa fa-google fc3" aria-hidden="true"></i></a>
			...
			<div class="col-md-3 team_gd1 wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
				<div class="team_pos">
					<div class="team_back"></div>
					<img class="img-responsive" src="/assets/user/images/t4.jpg"  alt=" ">
					<div class="team_info">
						<a href="#"  class="face_one"><i class=" so1 fa fa-facebook fc1" aria-hidden="true"></i></a>
						<a href="#"  class="face_one"><i class=" so2 fa fa-twitter fc2" aria-hidden="true"></i></a>
						<a href="#"  class="face_one"><i class=" so3 fa fa-google fc3" aria-hidden="true"></i></a>
...
<div class="event" id="events">
	<div class="container">
		...
		<div class="col-md-4 eve-agile e1">
			<div class="eve-sub1">
				<a href="#" data-toggle="modal" data-target="#myModal5"><img src="/assets/user/images/e2.jpg" alt="image"></a>
		...
		<div class="col-md-4 eve-agile e2">
			<div class="eve-sub1">
				<a href="#" data-toggle="modal" data-target="#myModal6"><img src="/assets/user/images/e1.jpg" alt="image"></a>
		...
		<div class="col-md-4 eve-agile e3">
			<div class="eve-sub1">
				<a href="#" data-toggle="modal" data-target="#myModal7"><img src="/assets/user/images/e3.jpg" alt="image"></a>
								...
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
											<h4>Educational</h4>
											<img src="/assets/user/images/e2.jpg" alt="blog-image" />
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
											<h4>Educational</h4>
											<img src="/assets/user/images/e1.jpg" alt="blog-image" />
											<span>Lorem ipsum dolor sit amet, Sed ut perspiciatis unde omnis iste natus error sit voluptatem , eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.accusantium doloremque laudantium.</span>
									</div>
								</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
											<h4>Educational</h4>
											<img src="/assets/user/images/e3.jpg" alt="blog-image" />
											<span>Lorem ipsum dolor sit amet, Sed ut perspiciatis unde omnis iste natus error sit voluptatem , eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.accusantium doloremque laudantium.</span>
									</div>
								</div>
						...
						<div class="sreen-gallery-cursual">
						       ...
						       <div id="owl-demo" class="owl-carousel">
					                 <div class="item-owl">
										...
										<p><img src="/assets/user/images/left-quote.png" alt="">Lorem ipsum dolor sit ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<img src="/assets/user/images/right-quote.png" alt=""></p>
											<div class="img-agile">
												<img src="/assets/user/images/t1.jpg" class="img-responsive" alt=""/>
											</div>
											  <h5>James</h5>
					                	    </div>
					                </div>
					                 <div class="item-owl">
					                	<div class="test-review">
										 <p> <img src="/assets/user/images/left-quote.png" alt="">Lorem ipsum dolor sit ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<img src="/assets/user/images/right-quote.png" alt=""></p>
						                	<div class="img-agile">
											<img src="/assets/user/images/t2.jpg" class="img-responsive" alt=""/>
											</div>
					                 ...
					                 <div class="item-owl">
					                	<div class="test-review">
										     <p><img src="/assets/user/images/left-quote.png" alt="">Lorem ipsum dolor sit ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<img src="/assets/user/images/right-quote.png" alt=""></p>
						                	<div class="img-agile">
											<img src="/assets/user/images/t3.jpg" class="img-responsive" alt=""/>
											</div>
											<h5>Richard</h5>
					                	</div>
					                </div>
	...
	<div class="footer" id="footer">
		<div class="container">
			...
			<div class="w3agile_footer_copy">
				<p>© 2017 Educational. All rights reserved | Design by <a href="http://www.thebesttutorials.com/">TheBestTutorials</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
...
<!-- js -->
<script type="text/javascript" src="/assets/user/js/jquery-2.1.4.min.js"></script>


<script src="/assets/user/js/jquery.chocolat.js"></script>
		<link rel="stylesheet" href="/assets/user/css/chocolat.css" type="text/css" media="screen">
		<!--light-box-files -->
		<script>
		$(function() {
...
<!-- start-smoth-scrolling -->
	...
	<!-- //smooth scrolling -->
	<!--// bottom-top -->
<script type="text/javascript" src="/assets/user/js/bootstrap-3.1.1.min.js"></script>
